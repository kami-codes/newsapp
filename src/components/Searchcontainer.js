...
export class Searchcontainer extends Component {
    ...
    constructor(props) {
        super(props)
        this.state = {
            search1:this.props.search,
            brand: "Ford",
            articles: ['hello'],
            pageIndex: 1,
            url: `https://newsapi.org/v2/everything?q=${this.props.search}&sortBy=popularity&apiKey=f29c4e7b2ece4bcd9f7578e7133cfef5&pageSize=15&page=`,
            totalNews: 0,
            noOfPages: 0,
            loading: true
        };
        ...
        return (
            <>
                <div className=" container "  >
                    <h1 className={`my-4 ${this.props.theme === 'dark' ? 'text-light' : ''}`}>Top Headlines of India containing term "{`${this.props.search}`}"</h1>
